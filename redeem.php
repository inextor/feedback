...
if( !empty( $_GET['gift_code']) )
{
	...
	if( empty( $feedback_response->redeemed_timestamp ) && !empty( $_GET['redeem'] ) && $_GET['redeem'] === 'redeem' )
	{
		$feedback_response->redeemed_timestamp = 'CURRENT_TIMESTAMP';

		if(!$feedback_response->update('redeemed_timestamp') )
		{
...
<html>
	...
	<body class="body">
		<div style="margin:auto auto;width:100%;max-width:960px;">
			<form name="form" method="GET" id="form" action="">
				<input type="hidden" value="" id="redeem" name="redeem">
				<div class="card">
					...
					<div class="card-body p-4">
						...
						<div class="row">
							<div class="col-8 form-group">
								<label>Código</label>
								<input type="text" name="gift_code" class="form-control" value="<?=$_GET['gift_code']??''?>">
							</div>
